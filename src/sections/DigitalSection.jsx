...
const DigitalSection = () => {
    return (
        <section className=' bg-zinc-950' >
            ...
            <div className='container mx-auto flex flex-row items-center justify-center py-20'>
                <div className='w-1/2'>
                ...
                <div className='w-1/2 flex flex-col gap-4 items-center justify-center'>
                    <div className='bg-zinc-900 w-full flex flex-col items-start justify-center p-6 select-none shadow-md hover:shadow-lg transition-shadow duration-300'>
