        ...
        <section className=' bg-zinc-950' >
            ...
            <div className='container mx-auto flex flex-col px-8 xl:px-0 xl:flex-row gap-20 items-center justify-center py-20'>
                ...
                <div className='w-full xl:w-1/2 flex flex-col gap-4 items-center justify-center'>
                    <div className='group ease-in-out bg-zinc-900 border hover:border-yellow-400/20 w-full flex flex-row items-center justify-start gap-4 p-6 select-none shadow-md hover:shadow-lg transition-all duration-300'>
