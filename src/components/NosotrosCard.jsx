...
const NosotrosCard = ({imgCard, title, description}) => {
    return (
        <div className='border-4 border-yellow-200 hover:border-yellow-300  sm:w-90 w-full h-fit sm:h-72 py-12 sm:pt-8 p-4 bg-zinc-950 transition-all ease-in-out'>
